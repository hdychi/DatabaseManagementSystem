...
import com.example.administrator.databasemanagementsystem.databinding.AllChooseFragmentBinding;
...
import com.example.administrator.databasemanagementsystem.viewModels.AllChooseViewModel;
...
public class AllChooseFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savadInstanceState){
        ...
        layout = inflater.inflate(R.layout.all_choose_fragment,null);
        AllChooseFragmentBinding binding = DataBindingUtil.inflate(inflater,R.layout.all_choose_fragment,null,false);
        AllChooseViewModel model = new AllChooseViewModel(mContext);
